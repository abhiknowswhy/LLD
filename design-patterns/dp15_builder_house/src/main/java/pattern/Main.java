...
import pattern.Builders.ClayHouseBuilder;
import pattern.Builders.GingerbreadHouseBuilder;
import pattern.Builders.WoodHouseBuilder;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		HouseBuilder stoneHouseBuilder = new pattern.Builders.StoneHouseBuilder();
